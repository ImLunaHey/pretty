export const DailyTargets_30102023 = () => {
  return (
    <div className="bg-[#F58220] w-screen h-screen">
      ...
      <div className="bg-[#F58220] absolute w-[30px] h-[30px] top-[60px] left-[185px]" />
      <div className="bg-[#FFFFFF] absolute w-[30px] h-[30px] top-[90px] left-[185px]" />
      <div className="bg-[#FFFFFF] absolute w-[30px] h-[30px] top-[180px] left-[185px]" />
      <div className="bg-[#F58220] absolute w-[30px] h-[30px] top-[210px] left-[185px]" />
    </div>
  );
};
